...
<html lang="id">
	<head>
		...
		<link href="<?= base_url(mix('admin/plugins/custom/datatables/datatables.bundle.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="<?= base_url(mix('admin/plugins/custom/datatables/datatables.bundle.js')); ?>"></script>
	<!--end::Page Vendors-->
